...
class ExportOptions:
    ...
    link_target: Optional[str] = None  # _blank, _self, etc.
...
class DrawioSVGExporter:
    ...
    def _parse_diagram_node(self, diagram: ET.Element) -> Optional[ET.Element]:
    ...
    def _get_cell_bounds(self, cell: ET.Element, root_cell: ET.Element) -> Optional[Bounds]:
    ...
    def _find_cell_by_id(self, root_cell: ET.Element, cell_id: str) -> Optional[ET.Element]:
        """Find cell by ID"""
        for cell in root_cell:
    ...
    def _calculate_edge_points(self, edge_state: CellState,
                             source_state: Optional[CellState],
                             target_state: Optional[CellState]) -> List[Tuple[float, float]]:
    ...
    def _create_path_data(self, points: List[Tuple[float, float]], 
        ...
        elif edge_style in ['orthogonalEdgeStyle', 'elbowEdgeStyle']:
